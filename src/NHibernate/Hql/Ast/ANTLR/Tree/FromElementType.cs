...
namespace NHibernate.Hql.Ast.ANTLR.Tree
{
	...
	public class FromElementType
	{
		...
		public string RenderPropertySelect(int size, int k, bool allProperties)
		{
			...
			return Queryable?.PropertySelectFragment(TableAlias, GetSuffix(size, k), allProperties) ?? string.Empty;
		}
		...
		public SelectFragment GetPropertiesSelectFragment(int size, int k, bool allProperties)
		{
			...
			return Queryable?.GetPropertiesSelectFragment(TableAlias, GetSuffix(size, k), allProperties);
		}
